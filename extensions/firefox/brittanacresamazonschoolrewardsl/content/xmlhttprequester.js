function brittanacresamazonschoolrewardsl_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
brittanacresamazonschoolrewardsl_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				brittanacresamazonschoolrewardsl_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
brittanacresamazonschoolrewardsl_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
brittanacresamazonschoolrewardsl_xmlhttpRequester.prototype.setupRequestEvent =
